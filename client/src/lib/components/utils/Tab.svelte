<!-- Taken from https://github.com/skeletonlabs/skeleton/blob/master/packages/skeleton/src/lib/components/Tab/Tab.svelte -->
<script lang="ts">
	import type { CssClasses, SvelteEvent } from '$lib/types/components';
	// Slots
	/**
